...
namespace Utilities
{
    public class DBConnect
    {
        // Main Connection String - used for the published web application and project submissions.
          String SqlConnectString = "server=cis-mssql1.temple.edu;Database=sp21_3342_tuh17229;User id=tuh17229;Password=zusieG7ao4";

        // Home Connection String - used for working from home using SSH Tunneling.
        //String SqlConnectString = "server=127.0.0.1,5555;Database=sp21_3342_tui34800;User id=tui34800;Password=poh3Uishie";
